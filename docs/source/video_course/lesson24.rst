...
Lektion 24: Tragbare Projekte mit Power Pack betreiben
=============================================================================

Dieses Tutorial behandelt die Stromversorgung eines Raspberry Pi Pico W-Projekts mit einem Power Pack, wodurch das Projekt tragbar wird:
...
* **Stromversorgung des Projekts mit einem Power Pack**: Verbindet das Power Pack und passt die LCD-Stromversorgung auf 3.7V an.
