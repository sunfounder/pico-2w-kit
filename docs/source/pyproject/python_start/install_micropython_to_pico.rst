...
1.3 MicroPython auf Ihrem Pico 2 W installieren
===================================================


Nun kommen wir zur Installation von MicroPython auf dem Raspberry Pi Pico 2 W.
...
#. Press and hold the **BOOTSEL** button and then connect the Pico 2 W to computer via a Micro USB cable. Release the **BOOTSEL** button after your Pico 2 W is mount as a Mass Storage Device called **RPI-RP2350**.
...
#. In the **Target volume**, the volume of the Pico 2 W you just plugged in will automatically appear, and in the **Micropython variant**, select **Raspberry Pi.Pico 2 W/Pico 2 WH**.
...
Herzlichen Glückwunsch, jetzt ist Ihr Raspberry Pi Pico 2 W einsatzbereit.
