...
2. Reading Data from an RFID Tag:
   ...
   * Prints out the tag's ID and the data read from the tag.
   ...
   .. note::
       ...
       Open the ``6.5_rfid_read.py`` file from ``pico-2w-starter-kit-main/micropython`` or copy this code into Thonny, then click “Run Current Script” or simply press F5 to run it.
