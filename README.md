# Pico-2w-starter-kit-for-raspberry-pi
...
## About this kit:
This pico2w starter kit applies to the Raspberry Pi Pico 2W. It includes various components and chips that can help to create various interesting phenomena which you can get via some operation with the guidance of  experiment instructions. In this process, you can learn some basic knowledge about programming. Also you can explore more application by yourself. Now go for it!  
...
<a id="license"></a>
## License
This is the code for SunFounder pico 2w starter kit for Raspberry Pi.
